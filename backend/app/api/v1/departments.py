...
def read_departments(
    ...
    return [schemas.DepartmentResponse.from_orm(dept) for dept in departments]
...
def read_department(
    ...
    return schemas.DepartmentResponse.from_orm(department)
...
def create_department(
    ...
    return schemas.DepartmentResponse.from_orm(db_department)
...
def update_department(
    ...
    return schemas.DepartmentResponse.from_orm(db_dept)
